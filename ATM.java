...
class bankaccount{
    static  void register(){
        ...
        System.out.println("Enter High Security Pin :");
        String pass=sc.nextLine();
        System.out.println("Enter Your SBI Account Number :");
        ATM.accnumber=sc.nextLine();
        System.out.println("REGISTRATION SUCCESSFULLY!...Thanks for registration (Apka Apna Bank Sbi Bank of India");
        System.out.println("----------Use Yono Sbi-----------------");
        ATM.prompt();
        while(true){
            display(ATM.name);
...
public class ATM {
    ...
    public static void homepage(){
        ...
        System.out.println("Enter your choice(Yono Sbi)");
        int choice =sc.nextInt();
        if (choice==1){
